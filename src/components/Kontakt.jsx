      ...
      <Row className="kontakt__container">
        <Col xs={12} md={6}>
          <Row className="justify-contet-center pt-lg-5">
            <h2 className="kontakt__h2 title pb-0 text-start pb-md-3 ps-5">Kontakt</h2>

            <Col xs={12} md={12} className="kontakt__info pb-md-3 order-1  pb-0  ps-5 ">
              <a href="/">
            ...
            <Col xs={12} className="kontakt__form order-3 order-md-2 px-5">
              ...
              <Col xs={12} md={12} className="kontakt__map order-2 d-md-none">
                <Iframe
                  className=" w-100"

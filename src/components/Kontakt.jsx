      ...
      <Row className="kontakt__container">
        <Col xs={12} md={6}>
          <Row className="justify-contet-center">
            <h2 className="title text-center text-md-start pb-md-3">Kontakt</h2>


            <Col xs={6} md={12} className="pb-md-3 order-1 px-3 pb-0">
              <Row>
            ...
            <Col xs={12} className="kontakt__form order-3 order-md-2 px-5">
                  ...
                  <Row>
                    <Col xs={6} className="p-0 pe-2">
                      <Form.Group className="mb-3" controlId="formGroupEmail">
                        ...
                        <Form.Control required type="firstName" className="p-md-2" />
                    ...
                    <Col xs={6} className="p-0">
                      <Form.Group className="mb-3" controlId="formGroupPassword">
                        ...
                        <Form.Control required type="lastName" className="p-md-2" />
                      </Form.Group>
                    </Col>

                    <Col xs={6} className="p-0 pe-2">
                      <Form.Group className="mb-3" controlId="formGroupEmail">
                        <Form.Label className="ps-1 m-0">
                          Email address
                        </Form.Label>
                        <Form.Control required type="email" className="p-md-2" />
                      </Form.Group>
                    </Col> */}
              ...
              <Col xs={6} md={12} className="kontakt__map order-2 d-md-none">
                <Iframe
        ...
        <Col xs={0} md={6} className="d-none d-md-block map-desktop">
          <Iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2258.3565574705253!2d9.467072416023282!3d55.526158380493285!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x464c9e5359e6d273%3A0xc5f8b0a835dc6087!2sGrydh%C3%B8j%2016%2C%206000%20Kolding!5e0!3m2!1sda!2sdk!4v1649070499669!5m2!1sda!2sdk"
            allowFullscreen=""
            loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
            className="map-desktop__iframe"
          ></Iframe>
        </Col>
      </Row>
